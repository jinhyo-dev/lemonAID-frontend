        ...
        .then(res => {
          if (res.status === 200) {
            ...
            axiosInstance.post('/post/pending_job_images_upload', form, {
              ...
              .then(() => alert('A pending post has been created. Please wait for administrator to confirm.'))
              .catch(() => alert('The file size is too large or there is a problem with the network. Please try again.'))
